...
#load data set
with open("C:/Users/tulik/Desktop/botnet/dataset/flowdata.pickle", 'rb') as file:
    sd=pickle.load(file, encoding="bytes") 
#file = open('C:/Users/tulik/Desktop/Botnet-detection-master/Botnet-detection-master/dataset/flowdata.pickle', 'rb')
#sd = pickle.load(file).decode('utf-8')
